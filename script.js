...
function createUnifiedGalaxy(parameters, isMobile, isHighEndMobile) {
    ...
    // 🌟 Cantidades MASIVAS para rellenar todos los huecos visuales
    const starCount = isMobile ? (isHighEndMobile ? 85000 : 35000) : 250000;
    const dustCount = isMobile ? (isHighEndMobile ? 22000 : 9000) : 55000;
    ...
    // 🌟 Partículas de polvo y estrellas ligeramente más grandes para crear masa continua
    const dustLayer = buildLayer(dustCount, isMobile ? 0.095 : 0.135, dustTexture, 0.18, true);
    const starsLayer = buildLayer(starCount, isMobile ? 0.024 : 0.032, starTexture, 0.9, false);
