...
// FIX DEFINITIVO EXYNOS: Inset de UVs para evitar el sangrado de bordes (géiseres)
[starTexture, asteroidFlareTexture, auraTexture, blueSecretAuraTexture, galaxyStreakTexture].forEach(tex => {
    tex.repeat.set(0.96, 0.96);
    tex.offset.set(0.02, 0.02);
});
